...
public class SyntaticAnalysis {
  ...
  private BlocksCommand procCmdList() {
    ...
    Command c = procCmd();
    cb.addCommand(c);
    while (current.type == TokenType.VAR || current.type == TokenType.OUTPUT || current.type == TokenType.IF
  ...
  private IntExpr procIntExpr() {
    ...
    if (current.type == TokenType.ADD | current.type == TokenType.SUB | current.type == TokenType.MUL
        | current.type == TokenType.DIV | current.type == TokenType.MOD) {
      int line = lex.getLine();
